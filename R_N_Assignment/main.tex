...
\begin{lstlisting}
$ wget https://github.com/Prabhav11004/AI1110-ASSIGNMENTS/blob/main/R_N_Assignment/Codes/exrand.c
$ wget https://github.com/Prabhav11004/AI1110-ASSIGNMENTS/blob/main/R_N_Assignment/Codes/coeffs.h
\end{lstlisting}
...
\begin{lstlisting}
$ wget https://github.com/Prabhav11004/AI1110-ASSIGNMENTS/blob/main/R_N_Assignment/Codes/cdf_plot.py
\end{lstlisting}
It is executed with
\begin{lstlisting}
$ python3 cdf_plot.py
...
\begin{lstlisting}
$ wget https://github.com/Prabhav11004/AI1110-ASSIGNMENTS/blob/main/R_N_Assignment/Codes/mean_var.c
$ wget https://github.com/Prabhav11004/AI1110-ASSIGNMENTS/blob/main/R_N_Assignment/Codes/mean_var.h
\end{lstlisting}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{gau_cdf.png}
\caption{The CDF of $X$}
\label{fig:gauss_cdf}
\end{figure}
The required python file can be downloaded using
\begin{lstlisting}
$ wget https://github.com/Prabhav11004/AI1110-ASSIGNMENTS/blob/main/R_N_Assignment/Codes/q2.2_cdf_gau_plot.py
\end{lstlisting}
and executed using
\begin{lstlisting}
$ python3 q2.2_cdf_gauss_plot.py
\end{lstlisting}
		\begin{enumerate}
...
\begin{lstlisting}
$ wget https://github.com/Prabhav11004/AI1110-ASSIGNMENTS/blob/main/R_N_Assignment/Codes/pdf_plot.py
\end{lstlisting}
...
\begin{lstlisting}
$ wget https://github.com/Prabhav11004/AI1110-ASSIGNMENTS/blob/main/R_N_Assignment/Codes/q2.4_mean_var.c
$ wget https://github.com/Prabhav11004/AI1110-ASSIGNMENTS/blob/main/R_N_Assignment/Codes/mean_var.h
\end{lstlisting}
and compiled and executed with the following commands
\begin{lstlisting}
$ gcc q2.4_mean_var.c -lm 
$ ./a.out
\end{lstlisting}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{exp_cdf.png}
